    ...
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-40 pointer-events-auto">
      ...
      <div className="flex items-center gap-2 px-4 py-2 bg-[#202124] rounded-full shadow-lg border border-gray-700/50 relative">
        ...
        {onToggleViewMode && (
          <button
            onClick={() => {
              console.log('[MeetStyleControls] Grid button clicked, current viewMode:', viewMode);
              onToggleViewMode();
            }}
            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all
              ${viewMode === 'grid'
          ...
          >
            {viewMode === 'grid' ? (
              /* Speaker View Icon - Single person */
              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            ) : (
              /* Grid View Icon - Grid of squares */
              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          onClick={onLeave}
          className="w-10 h-10 rounded-full bg-[#ea4335] hover:bg-[#d93025] flex items-center justify-center transition-all text-white"
